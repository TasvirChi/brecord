package com.borhan.devicedetection
{
	 ...
	 *  @eventType com.borhan.devicedetection.DeviceDetectionEvent.DETECTED_MICROPHONE
	 */
	 ...
	 *  @eventType com.borhan.devicedetection.DeviceDetectionEvent.ERROR_MICROPHONE
	 */
	 ...
	 *  @eventType com.borhan.devicedetection.DeviceDetectionEvent.MIC_DENIED
	 */
	[Event(name = "micDenied", type = "com.borhan.devicedetection.DeviceDetectionEvent")]

	
	/**
	 *  dispatched to notify microphone is allowed by user.
	 *  @eventType com.borhan.devicedetection.DeviceDetectionEvent.MIC_ALLOWED
	 */
	[Event(name = "micAllowed", type = "com.borhan.devicedetection.DeviceDetectionEvent")]

	
	/**
	 *  dispatched to notify microphone detection steps
	 *  event.detectedDevice is debug message
	 *  @eventType com.borhan.devicedetection.DeviceDetectionEvent.MIC_DEBUG
	 */
	[Event(name = "micDebug", type = "com.borhan.devicedetection.DeviceDetectionEvent")]
